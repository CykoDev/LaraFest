        ...
        <div class="col">
            <div class="card shadow mb-4 mr-5">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Discount Package: {{ ucwords($package->name) }}</h6>
                </div>
                <div class="card-body">


                    {!! Form::open(['method'=>'POST', 'action'=>'PackageController@storeDiscount', 'files'=>false]) !!}

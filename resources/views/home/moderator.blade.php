...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Moderator Dashboard</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col my-auto">
            <div class="text-center">
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 20rem;" src="{{ asset('img/public/undraw_develop_app_kvt2.svg') }}" alt="">
            </div>
        </div>
    </div>

...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Monitor Dashboard</h1>
    </div>
    ...
    <div class="row">
        @include('layouts.components.areachart', [
            'id' => 'regAreaChart',
            'heading' => 'Applicant Registration Status',
        ])
        <div class="col my-auto">
            <div class="text-center">
                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 20rem;" src="{{ asset('img/public/undraw_access_account_99n5.svg') }}" alt="">
            </div>
        </div>
    </div>
